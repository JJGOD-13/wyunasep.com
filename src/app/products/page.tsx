...
let products1 = [
  {
    title: "Hydrocyclone",
    description:
      "Our State of the art product delivering preicse seperation for almost all needs.",
    image: "link/to/image",
  ...
  },
  {
    ...
    description:
      "Efficient Coolant Filtration for a wide range of applications.",
  ...
  return (
    <div className=" card card-compact p-2 md:card-normal w-[300px]   bg-neutral h-fit md:h-[240px] md:w-[400px] text-base-content  ">
      <div className=" card-body  ">
        <h2 className=" card-title  justify-center md:justify-normal text-center md:text-start ">
          {product.title}
        </h2>
        <p className=" justify-center text-center text-balance md:text-start ">
          {product.description}
        </p>
      </div>
      <div className=" card-actions justify-center mb-2 md:justify-end md:pr-5 md:pb-5 ">
        <Link
          href={product.link}
          className=" btn btn-sm md:btn-md btn-info text-info-content "
        >
          Read More
        </Link>
      </div>
